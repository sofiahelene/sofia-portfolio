    ...
    <div class="page page-inner page-about">
      ...
      <div class="about-content">
        <div class="about-content-inner">
          <p class="about-lead">${t('Bonjour ! Je suis Sofia, directrice artistique britannique.', 'Hey! I\'m Sofia, a British art director living in France.')}</p>
          ...
          <p>${t('En dehors de mes études, j\'aime l\'escalade, la musique électronique, le cinéma, la cuisine et la lecture.', 'Outside of my studies, I\'m obsessed with music — especially electronic, and I love collaborating with musicians and working on musical projects. I also love motion design, photography, storytelling, montage, and in my free time you\'ll find me watching a film or reading a book (bonus points if it\'s a thriller!)')}</p>
